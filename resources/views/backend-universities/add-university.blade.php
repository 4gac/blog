...
@section('content')
<form method="post" action="{{action('UniversityController@addUniverzitaAction')}}">
	<div class="form-group">
		<div class="form-row">
			...
			<div class="form-group col-md-3">
				...
				<input type="date"class="form-control" id="zmluva_od-id" name="zmluva_od" value=""> <br>
			</div>
			<div class="form-group col-md-3">
				<label for="zmluva_do-id">Zmluva do</label>
				<input type="date"class="form-control" id="zmluva_do-id" name="zmluva_do" value=""> <br>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-6">
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				...
				<input type ="text" class="form-control" id="kontaktna_osoba-id" name="kontaktna_osoba" value=""> <br>
			</div>
		</div>
